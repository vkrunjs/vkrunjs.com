...
description: "Learn how to use the .notEqual method in Schema to validate if a value does not match a specified reference value."
---
...
const exampleSchema = schema().string().notEqual(["hello", "world])

const validateA = exampleSchema.validate("hi")
