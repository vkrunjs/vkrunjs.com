...
const exampleSchema = schema().string().time({ type: 'HH:MM' })
...
const exampleSchema = schema().string().time({ type: 'HH:MM:SS' })
...
const exampleSchema = schema().string().time({ type: 'HH:MM:SS.MS' })
