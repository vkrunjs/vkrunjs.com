---
title: "Schema OneOf"
description: "Learn how to use the .oneOf method in Schema to validate if a value matches one of several specified values or schemas."
---
...
const exampleSchema = schema().string().oneOf(comparisonItems);
